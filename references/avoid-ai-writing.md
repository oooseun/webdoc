...
This is an unmodified copy of that project's SKILL.md, bundled with webdoc under the
terms of the MIT License (see ../NOTICE). webdoc always applies these rules when
writing prose for a site or doc; the operational core is summarized in ../SKILL.md.
-->
